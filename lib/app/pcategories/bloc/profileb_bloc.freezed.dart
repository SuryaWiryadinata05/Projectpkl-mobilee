...
class _$ProfilebStateTearOff {
  ...
  _IsSuccess isSuccess(ProjectResponse projectResponse) {
    return _IsSuccess(
      projectResponse,
    );
  }
...
mixin _$ProfilebState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ProjectResponse projectResponse) isSuccess,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(ProjectResponse projectResponse)? isSuccess,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
class _$_IsError implements _IsError {
  ...
  @override
  String toString() {
    return 'ProfilebState.isError(errorMesssage: $errorMesssage)';
  }
...
class __$IsSuccessCopyWithImpl<$Res> extends _$ProfilebStateCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? projectResponse = freezed,
  }) {
    return _then(_IsSuccess(
      projectResponse == freezed
...
class _$_IsSuccess implements _IsSuccess {
  const _$_IsSuccess(this.projectResponse);
  ...
  @override
  String toString() {
    return 'ProfilebState.isSuccess(projectResponse: $projectResponse)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _IsSuccess &&
            const DeepCollectionEquality()
                .equals(other.projectResponse, projectResponse));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(projectResponse));
  ...
  TResult when<TResult extends Object?>({
    ...
    return isSuccess(projectResponse);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return isSuccess?.call(projectResponse);
  }
...
abstract class _IsSuccess implements ProfilebState {
  const factory _IsSuccess(ProjectResponse projectResponse) = _$_IsSuccess;
